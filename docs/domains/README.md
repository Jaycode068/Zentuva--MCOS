...
| [Accounting](accounting.md)         | Foundation implemented — Sprint 7 (Chart of Accounts, Accounting Periods, double-entry Journal Entries, General Ledger/Trial Balance/Account Activity; posts automatically for Finance's Invoice/Payment/Credit-Note events only — not a complete accounting system, see accounting.md §9) |
