  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="space-y-6">
        <AvatarCard profile={profile} fallbackInitials={initials} />
...
function AvatarCard({
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: (updated) => queryClient.setQueryData(['account', 'profile'], updated),
  });
  ...
  return (
    <ImageUploadCard
      title="Profile Photo"
      description="Shown across Zentuva wherever your account is represented."
